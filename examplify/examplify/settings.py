"""
Django settings for examplify project.
...
SECRET_KEY = 'django-insecure-%%ewyec6(4ahqhdxd^27ep*45s(j-p!i(4$d_n&e=ls5^62399'
...
WSGI_APPLICATION = 'examplify.wsgi.application'
